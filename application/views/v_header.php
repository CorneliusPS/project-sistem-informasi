  ...
  <body>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-white" href="#" id="navMaster" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Master Data
            </a>
            <div class="dropdown-menu" aria-labelledby="navMaster">
            <a class="dropdown-item" href="<?= base_url('users'); ?>">Data Pegawai</a>
        ...
        <li class="nav-item">
            <a class="nav-link text-white" href="<?= base_url('kunjungan');?>">Kunjungan/Berobat</a>
        </li>

        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-white" href="#" id="navLaporan" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Laporan
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link btn btn-dark" href="<?= base_url('auth/logout');?>">Logout</a>
        </li>
