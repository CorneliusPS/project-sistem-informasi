        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card border-danger">
                    ...
                    <div class="card-body">
                        <form method="post" action="<?= base_url(); ?>kunjungan/insert_rm" enctype="multipart/form-data">
                ...
                <div class="card border-success mt-8">
                                    ...
                                    <div class="form-group">
                                        <select name="obat" id="" class="form-control">
                                            <?php foreach ($obat as $r) { ?>
                                                <option value="<?= $r['id_obat']; ?>"><?= $r['name_obat']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <tbody>
                                ...
                                foreach ($resep as $r) { ?>
                                    <tr>
                                        ...
                                        <td><?= $r['name_obat']; ?></td>
                                        <td>
                                            <a href="<?= base_url() . 'kunjungan/hapus_resep/' . $r['id_resep'] . '/' . $r['id_berobat']; ?>" class="btn btn-danger btn-sm" onClick="return confirm('Yakin akan menghapus data?')">Hapus</a>
                                        </td>
                                    </tr>
                                <?php $no++;
                                } ?>
                    ...
                    <tbody>
                        ...
                        foreach ($riwayat as $r) { ?>
                            ...
                            <tr>
                                ...
                                <td><img src="<?= base_url(); ?>assets/img/<?= $r['image']; ?>" alt=""></td>
                            </tr>
